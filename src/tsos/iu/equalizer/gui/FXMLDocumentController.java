...
import tsos.iu.equalizer.player.AudioPlayer;
import java.net.URL;
import java.io.File;
...
public class FXMLDocumentController implements Initializable {
    ...
    private void stop() {
        ...
        this.clippingSlider.setValue(1.0);
    }
    ...
    private void listenSliders(){
        ...
        clippingSlider.valueProperty().addListener((ObservableValue<? extends Number> observable, Number oldValue, Number newValue) -> {
            String str = String.format("%.1f", (newValue.doubleValue()));
            audioPlayer.setClippingCoef(newValue.doubleValue());
        });
    }
